...
def render_section_header(text):
    ...
    st.markdown(f"""
    <div style="background-color: #003366; color: #FFFFFF; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
        <h2 style="margin: 0; font-size: 28px; font-weight: 700;">{text}</h2>
    </div>
